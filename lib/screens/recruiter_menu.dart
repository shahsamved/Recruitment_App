...
import 'package:recruitment/screens/recruiter_contact_us.dart';
import 'package:recruitment/screens/recruiter_home_page.dart';
import 'package:recruitment/screens/recruiter_login.dart';
import 'package:recruitment/screens/recruiter_notification.dart';
import 'package:recruitment/screens/recruiter_profile.dart';
import 'package:recruitment/screens/recruiter_settings.dart';
import 'package:recruitment/screens/settings.dart';
import 'package:recruitment/size_config.dart';
import '/pallete.dart';

class RMenu extends StatefulWidget {
  @override
  _RMenuState createState() => _RMenuState();
}

class _RMenuState extends State<RMenu> {
  bool isLoad = false;
  ...
  Future<void> _submit() async {
    ...
    try {
      await Provider.of<Auth>(context, listen: false).rlogout();
      print("here");
      Navigator.push(
                      ...
                      child: Container(
                          ...
                          child: InkWell(
                            onTap: () => Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => RecruiterHomePage())),
